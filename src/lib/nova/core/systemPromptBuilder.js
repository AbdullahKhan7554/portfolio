...
export function buildSystemPrompt({
  ...
  // Hard pricing policy — present UNLESS the client opts into quoting prices
  // (clientConfig.policy.quotePricesAllowed). When present it OVERRIDES anything
  // above, including any price / "from $X" / package figure in the knowledge.
  if (!clientConfig.policy?.quotePricesAllowed) {
    parts.push(
